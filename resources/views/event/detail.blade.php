    ...
    <main class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div class="lg:col-span-1">
            <div class="sticky top-32">
                ...
                {{-- Penyesuaian nama kolom menjadi poster_path --}}
                ...
                @else
                    <div class="w-full aspect-[3/4] bg-slate-100 rounded-[2.5rem] shadow-2xl border-8 border-white flex items-center justify-center text-slate-400 font-bold uppercase tracking-widest text-sm p-4 text-center">
                        No Image
                    </div>
                @endif
                ...
                <div class="mt-8 p-6 bg-white rounded-3xl border border-slate-100 shadow-sm">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            {{-- Penyesuaian relasi kategori --}}
                            <p class="font-bold text-slate-800">Panitia {{ $event->category->name ?? 'Event' }}</p>
        ...
        <div class="lg:col-span-2 space-y-12">
            ...
            <div class="prose prose-slate max-w-none">
                ...
                <p class="text-lg text-slate-600 leading-relaxed">
                    ...
                    {!! nl2br(e($event->description ?? 'Deskripsi tidak tersedia untuk event ini.')) !!}
                </p>
            </div>
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                    <div>
                        ...
                        <h2 class="text-5xl font-black">
                            {{-- Penyesuaian price & penanganan gratis --}}
                            @if($event->price == 0)
                                Gratis
                            @else
                        ...
                        <p class="mt-4 text-indigo-100 flex items-center gap-2">
                            ...
                            {{-- Penyesuaian stock (jika tidak ada kolom stock, akan otomatis menulis Tersedia) --}}
                            Sisa stok: <span class="font-bold underline">{{ $event->stock ?? 'Tersedia' }}</span>
                        </p>
                    </div>
                    <div>
                        <a href="{{ route('checkout', ['id' => $event->id]) }}" class="inline-block px-10 py-5 bg-white text-indigo-600 rounded-2xl font-black text-xl hover:scale-105 transition-transform shadow-xl">
                            Pesan Sekarang
                        </a>
                    </div>
                </div>
