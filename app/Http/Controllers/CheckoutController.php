...
class CheckoutController extends Controller
{
    ...
    public function store(Request $request, Event $event)
    {
        ...
        // Pastikan nama kolom (event_id, total_price, dll) sesuai dengan tabel migrations kamu
    ...
    /**
     * Membuat Jendela Pembayaran (Snap UI)
     */
    public function payment($order_id)
    {
        ...
        // Mengambil data transaksi beserta relasi event-nya
    ...
    /**
     * Menangani halaman sukses pembayaran dan validasi status ke Midtrans
     */
